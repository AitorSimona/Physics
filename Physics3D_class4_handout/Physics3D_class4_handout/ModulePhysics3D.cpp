...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<btPoint2PointConstraint*>* t_item = constraints.getFirst();
...
void ModulePhysics3D::AddConstraintP2P(PhysBody3D & bodyA, PhysBody3D & bodyB, const vec3 & anchorA, const vec3 & anchorB)
{
	...
	btPoint2PointConstraint  * constraint = new btPoint2PointConstraint(*bodyA.body,*bodyB.body, pivotInA, pivotInB);
