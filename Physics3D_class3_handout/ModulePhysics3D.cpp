...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item <PhysBody3D*> *body = physbody_list.getFirst();

	while(body!=NULL)
	{
		assert("PhysBody_data is null",body.data != NULL);
		delete body->data;
		body = body->next;
	}
	...
	p2List_item <btCollisionShape*> * coll_shape = shape_list.getFirst();

	while (body != NULL)
	{
		assert("coll_shape data is null", body.data != NULL);
		delete coll_shape->data;
		coll_shape = coll_shape->next;
	}
